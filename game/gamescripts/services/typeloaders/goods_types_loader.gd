...
func make_types_list() -> Array[BaseGoodsType]:
	return [
		...
		# food types
		BaseGoodsType.new("grains", BaseGoodsType.ResourceCategory.AGGREGATE),
		...
		BaseGoodsType.new("sugar", BaseGoodsType.ResourceCategory.AGGREGATE),
		BaseGoodsType.new("alcohol", BaseGoodsType.ResourceCategory.LIQUID),
		BaseGoodsType.new("fertilizer", BaseGoodsType.ResourceCategory.LIQUID),
		...
		BaseGoodsType.new("gravel", BaseGoodsType.ResourceCategory.AGGREGATE),
		BaseGoodsType.new("concrete", BaseGoodsType.ResourceCategory.AGGREGATE),
		# liquid goods
		...
		# aggregate goods
		BaseGoodsType.new("stone", BaseGoodsType.ResourceCategory.AGGREGATE),
		BaseGoodsType.new("coal", BaseGoodsType.ResourceCategory.AGGREGATE),
		BaseGoodsType.new("ore", BaseGoodsType.ResourceCategory.AGGREGATE),
